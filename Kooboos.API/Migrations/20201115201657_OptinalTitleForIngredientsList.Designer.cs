...
namespace Kooboos.API.Migrations
{
    ...
    [Migration("20201115201657_OptinalTitleForIngredientsList")]
    partial class OptinalTitleForIngredientsList
    {
            ...
            modelBuilder.Entity("Kooboos.API.IngredientsLists.Entities.IngredientsList", b =>
                {
                    b.HasOne("Kooboos.API.Recipes.Entities.Recipe", "Recipe")
                        ...
                        .HasForeignKey("Kooboos.API.IngredientsLists.Entities.IngredientsList", "RecipeId")
